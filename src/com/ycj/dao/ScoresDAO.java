 ...
 * 
 * @see com.ycj.entity.Scores
 * @author MyEclipse Persistence Tools
 */
@Transactional
@Repository("ScoresDAO")
public class ScoresDAO {
	...
	public Scores findById(java.lang.Integer id) {
		...
		try {
			Scores instance = (Scores) getCurrentSession().get("com.ycj.entity.Scores", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Scores instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.ycj.entity.Scores").add(Example.create(instance))
					.list();
	...
	public Scores merge(Scores detachedInstance) {
		...
		try {
			Scores result = (Scores) getCurrentSession().merge(detachedInstance);
